...
public class EventManager {
    ...
    private static boolean isMethodBad(final Method method) {
        return method.getParameterTypes().length != 1 || !method.isAnnotationPresent(EventAnnotation.class);
    }
    ...
    public static void register(final Method method, final Object o) {
        ...
        final EventData methodData = new EventData(o, method, method.getAnnotation(EventAnnotation.class).value());
