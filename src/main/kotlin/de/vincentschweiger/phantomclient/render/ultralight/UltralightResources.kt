...
import de.vincentschweiger.phantomclient.utils.io.HttpClient
import de.vincentschweiger.phantomclient.utils.io.extractZip
import de.vincentschweiger.phantomclient.utils.system.*
import java.io.File
...
class UltralightResources {
    ...
    fun downloadResources() {
        runCatching {
            ...
            val nativeUrl = "${Phantom.LIQUID_CLIENT_CLOUD}/ultralight_resources/$LIBRARY_VERSION/$os-x64.zip"
