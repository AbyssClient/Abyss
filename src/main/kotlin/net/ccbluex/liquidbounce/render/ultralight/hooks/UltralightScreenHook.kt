...
object UltralightScreenHook {
     ...
     */
    @EventAnnotation
    fun screenHandler(event: ScreenEvent) {
        ...
        val screen = event.screen ?: if (mc.world != null) return else TitleScreen()
        val name = UltralightJsUi.get(screen)?.name ?: return
        val page = ThemeManager.page(name) ?: return
